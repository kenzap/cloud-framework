 ...
 */
registerBlockType( 'kenzap/cta-40', {
    title: __( 'Number Counters', 'kenzap-stats' ),
    description: __( 'Note! Some changes of this block can be only previewed after refreshing the page.', 'kenzap-cta' ),
    icon: 'clock',
    category: 'layout',
    keywords: [
        __( 'kenzap cta 40', 'kenzap-stats' ),
        __( 'Animated Counter', 'kenzap-stats' ),
	...
	edit: ( props ) => {
        ...
        if ( props.attributes.preview ) return ( <img src={ `${ window.kenzap_cta_path + 'cta-40/preview.jpeg' }` } /> );

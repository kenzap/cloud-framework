 ...
 */
registerBlockType( 'kenzap/cta-72', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'Masonry Blog', 'kenzap-blog' ), // Block title.
	description: __( 'This block can be only previewed on website frontend.', 'kenzap-blog' ), // Block desc.
	icon: 'images-alt', // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
	category: 'layout', // Block category — Group blocks together based on common traits E.g. common, formatting, layout widgets, embed.
	keywords: [
		__( 'kenzap cta 72', 'kenzap-blog' ),
		__( 'blog posts', 'kenzap-blog' ),
		__( 'isotope news', 'kenzap-blog' ),
	],
	supports: {
        align: [ 'full', 'wide' ],
    },
    ...
    edit: ( props ) => {
		...
		// return ( <img src={ `${ window.kenzap_cta_path + 'cta-72/preview.jpeg' }` } /> );

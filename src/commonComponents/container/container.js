...
const PH = () => (
    ...
    <div style={ { "width": "100%", "background-color": "#EBEBEB" } }><div aria-hidden="true" role="img" focusable="false" className="dashicons dashicons-format-image" style={ {"cursor":"pointer", "font-size":"60px", "width":"240px", "height":"120px",  "overflow":"visible",  "padding-top":"30px", "padding-bottom":"30px", "background-color": "#EBEBEB", "color": "#fff" } } xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"></div></div>
        ...
        return (
            <Fragment>
                ...
                >
                        ...
                        render={ ( mediaUploadProps ) => (
                            <Fragment>
                                { ( backgroundImageId || backgroundImage !== 'none' ) ? (
                                    ...
                                    <span onClick={ mediaUploadProps.open }><PH /></span>
                                ) }
                            </Fragment>
                    ...
                    <CheckboxControl
                        label={ __( 'Image size optimization' ) }
                        checked={ optimize }
                        onChange={ ( optimize ) => {
                            setAttributes( {
                                optimize: optimize,

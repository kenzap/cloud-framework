...
( function( blocks, editor, i18n, element, components, _ ) {
    ...
    blocks.registerBlockType( 'kenzap/cta-33', {
        title: 'Team Members',
        description: __( 'List team members beautifully.' ),
        keywords: [ __( 'kenzap cta 33, members avatar' ),  __( 'users, employees' ), __( 'people, faces' ) ],
        ...
        edit: ( props ) => {
            ...
            if ( props.attributes.preview ) return ( <img src={ `${ window.kenzap_cta_path + 'cta-33/preview.jpeg' }` } /> );
			...
			return (
                el( Fragment,
                    ...
                    el( InspectorControls,
                        ...
                        el( PanelBody,
                            ...
                            el(RangeControl, {
                                ...
                                value: containerSidePadding || 0,
                                onChange: function onChange(size) {
                                    return setAttributes({ containerSidePadding: size });
                                },
                                min: 0,
                                max: 50,
                            }),
                            el(CheckboxControl, {
                                ...
                                onChange: function onChange(isChecked) {
                                    return setAttributes({ autoPadding: isChecked ? 'autoPadding' : '', });
                                },
                    ...
                    el(
                        "div",
                        { className: "kenzap-members-editor " + autoPadding,
                        style: {
                            ...
                            paddingTop: !autoPadding ? bgPadding:'',
                            paddingBottom: !autoPadding ? bgPadding:'',
                            paddingLeft: containerSidePadding,
                            paddingRight: containerSidePadding,
                            '--paddings': bgPadding+' ',
                            // padding: ((!autoPadding)? containerPadding+'px 0px': ''),
                        }
                        },
                                            ...
                                            el( MediaUpload, {
                                                ...
                                                render: function( obj ) {
                                                    ...
                                                    return el( components.Button, {
                                                            ...
                                                            onClick: obj.open,
                                                            style: {
                                                                height: items[index].mediaID ? avatarSize-(avatarBorderWidth*2) + 'px':'auto',
                                                            }
                                                        },
		...
		save: function( props ) {
			...
			return (
                el(
                    "section", { 
                        className: "kenzap-members " + contAlignment + " " + autoPadding,
                        style: {
                            backgroundColor: backgroundColor,
                            backgroundImage: backgroundImageUrl=="" ? "none" : ('url('+backgroundImageUrl+')'),
                            backgroundSize: bgObj[bgAlignment],
